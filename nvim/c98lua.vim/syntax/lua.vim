...
syn cluster luaExpr0   contains=luaCommentA0,luaConstant0,luaNumber0,luaString0,luaBuiltin0,luaTable0,luaOperator0,luaEllipsis0,luaComma0,luaFunc0,luaError0,luaWord0,luaUnop0,luaParen0
syn cluster luaExpr1   contains=luaCommentA1,luaConstant1,luaNumber1,luaString1,luaBuiltin1,luaTable1,luaOperator1,luaEllipsis1,luaComma1,luaFunc1,luaError1,luaWord1,luaUnop1,luaParen1
syn cluster luaExpr2   contains=luaCommentA2,luaConstant2,luaNumber2,luaString2,luaBuiltin2,luaTable2,luaOperator2,luaEllipsis2,luaComma2,luaFunc2,luaError2,luaWord2,luaUnop2,luaParen2
syn cluster luaExpr3   contains=luaCommentA3,luaConstant3,luaNumber3,luaString3,luaBuiltin3,luaTable3,luaOperator3,luaEllipsis3,luaComma3,luaFunc3,luaError3,luaWord3,luaUnop3,luaParen3
syn cluster luaExpr4   contains=luaCommentA4,luaConstant4,luaNumber4,luaString4,luaBuiltin4,luaTable4,luaOperator4,luaEllipsis4,luaComma4,luaFunc4,luaError4,luaWord4,luaUnop4,luaParen4
syn cluster luaExpr5   contains=luaCommentA5,luaConstant5,luaNumber5,luaString5,luaBuiltin5,luaTable5,luaOperator5,luaEllipsis5,luaComma5,luaFunc5,luaError5,luaWord5,luaUnop5,luaParen5
...
syn region  luaTable0            matchgroup=luaD0 start=/{/                  end=/}/              contains=@luaExpr1,luaTableKey1
syn region  luaTable1    contained         matchgroup=luaD1 start=/{/                  end=/}/              contains=@luaExpr2,luaTableKey2
syn region  luaTable2    contained         matchgroup=luaD2 start=/{/                  end=/}/              contains=@luaExpr3,luaTableKey3
syn region  luaTable3    contained         matchgroup=luaD3 start=/{/                  end=/}/              contains=@luaExpr4,luaTableKey4
syn region  luaTable4    contained         matchgroup=luaD4 start=/{/                  end=/}/              contains=@luaExpr5,luaTableKey5
syn region  luaTable5    contained         matchgroup=luaD5 start=/{/                  end=/}/              contains=@luaExpr0,luaTableKey0
...
syn region  luaTableKey1 contained matchgroup=luaD0 start=/\[/                 end=/]/              contains=@luaExpr1         skipwhite skipempty nextgroup=luaTableEq0
syn region  luaTableKey2 contained matchgroup=luaD1 start=/\[/                 end=/]/              contains=@luaExpr2         skipwhite skipempty nextgroup=luaTableEq1
syn region  luaTableKey3 contained matchgroup=luaD2 start=/\[/                 end=/]/              contains=@luaExpr3         skipwhite skipempty nextgroup=luaTableEq2
syn region  luaTableKey4 contained matchgroup=luaD3 start=/\[/                 end=/]/              contains=@luaExpr4         skipwhite skipempty nextgroup=luaTableEq3
syn region  luaTableKey5 contained matchgroup=luaD4 start=/\[/                 end=/]/              contains=@luaExpr5         skipwhite skipempty nextgroup=luaTableEq4
syn region  luaTableKey0 contained matchgroup=luaD5 start=/\[/                 end=/]/              contains=@luaExpr0         skipwhite skipempty nextgroup=luaTableEq5
...
syn region  luaParen0            matchgroup=luaD0 start=/(/                  end=/)/              contains=@luaExpr1         skipwhite skipempty nextgroup=@luaSuffix0
syn region  luaParen1    contained         matchgroup=luaD1 start=/(/                  end=/)/              contains=@luaExpr2         skipwhite skipempty nextgroup=@luaSuffix1
syn region  luaParen2    contained         matchgroup=luaD2 start=/(/                  end=/)/              contains=@luaExpr3         skipwhite skipempty nextgroup=@luaSuffix2
syn region  luaParen3    contained         matchgroup=luaD3 start=/(/                  end=/)/              contains=@luaExpr4         skipwhite skipempty nextgroup=@luaSuffix3
syn region  luaParen4    contained         matchgroup=luaD4 start=/(/                  end=/)/              contains=@luaExpr5         skipwhite skipempty nextgroup=@luaSuffix4
syn region  luaParen5    contained         matchgroup=luaD5 start=/(/                  end=/)/              contains=@luaExpr0         skipwhite skipempty nextgroup=@luaSuffix5
...
syn region  luaIndex0    contained matchgroup=luaD0 start=/\[/                 end=/\]/             contains=@luaExpr1         skipwhite skipempty nextgroup=@luaSuffix0
syn region  luaIndex1    contained matchgroup=luaD1 start=/\[/                 end=/\]/             contains=@luaExpr2         skipwhite skipempty nextgroup=@luaSuffix1
syn region  luaIndex2    contained matchgroup=luaD2 start=/\[/                 end=/\]/             contains=@luaExpr3         skipwhite skipempty nextgroup=@luaSuffix2
syn region  luaIndex3    contained matchgroup=luaD3 start=/\[/                 end=/\]/             contains=@luaExpr4         skipwhite skipempty nextgroup=@luaSuffix3
syn region  luaIndex4    contained matchgroup=luaD4 start=/\[/                 end=/\]/             contains=@luaExpr5         skipwhite skipempty nextgroup=@luaSuffix4
syn region  luaIndex5    contained matchgroup=luaD5 start=/\[/                 end=/\]/             contains=@luaExpr0         skipwhite skipempty nextgroup=@luaSuffix5
syn region  luaCall0     contained matchgroup=luaD0 start=/(/                  end=/)/              contains=@luaExpr1         skipwhite skipempty nextgroup=@luaSuffix0
syn region  luaCall1     contained matchgroup=luaD1 start=/(/                  end=/)/              contains=@luaExpr2         skipwhite skipempty nextgroup=@luaSuffix1
syn region  luaCall2     contained matchgroup=luaD2 start=/(/                  end=/)/              contains=@luaExpr3         skipwhite skipempty nextgroup=@luaSuffix2
syn region  luaCall3     contained matchgroup=luaD3 start=/(/                  end=/)/              contains=@luaExpr4         skipwhite skipempty nextgroup=@luaSuffix3
syn region  luaCall4     contained matchgroup=luaD4 start=/(/                  end=/)/              contains=@luaExpr5         skipwhite skipempty nextgroup=@luaSuffix4
syn region  luaCall5     contained matchgroup=luaD5 start=/(/                  end=/)/              contains=@luaExpr0         skipwhite skipempty nextgroup=@luaSuffix5
syn region  luaCall0     contained matchgroup=luaD0 start=/{/                  end=/}/              contains=@luaExpr1         skipwhite skipempty nextgroup=@luaSuffix0
syn region  luaCall1     contained matchgroup=luaD1 start=/{/                  end=/}/              contains=@luaExpr2         skipwhite skipempty nextgroup=@luaSuffix1
syn region  luaCall2     contained matchgroup=luaD2 start=/{/                  end=/}/              contains=@luaExpr3         skipwhite skipempty nextgroup=@luaSuffix2
syn region  luaCall3     contained matchgroup=luaD3 start=/{/                  end=/}/              contains=@luaExpr4         skipwhite skipempty nextgroup=@luaSuffix3
syn region  luaCall4     contained matchgroup=luaD4 start=/{/                  end=/}/              contains=@luaExpr5         skipwhite skipempty nextgroup=@luaSuffix4
syn region  luaCall5     contained matchgroup=luaD5 start=/{/                  end=/}/              contains=@luaExpr0         skipwhite skipempty nextgroup=@luaSuffix5
syn match   luaUnop0                              /[#~-]\|\<not\>/                                                           skipwhite skipempty nextgroup=@luaExpr0
syn match   luaUnop1     contained                          /[#~-]\|\<not\>/                                                           skipwhite skipempty nextgroup=@luaExpr1
syn match   luaUnop2     contained                          /[#~-]\|\<not\>/                                                           skipwhite skipempty nextgroup=@luaExpr2
syn match   luaUnop3     contained                          /[#~-]\|\<not\>/                                                           skipwhite skipempty nextgroup=@luaExpr3
syn match   luaUnop4     contained                          /[#~-]\|\<not\>/                                                           skipwhite skipempty nextgroup=@luaExpr4
syn match   luaUnop5     contained                          /[#~-]\|\<not\>/                                                           skipwhite skipempty nextgroup=@luaExpr5
syn match   luaBinop0    contained                  /[<>=~^&|*/%+-]/                                                           skipwhite skipempty nextgroup=@luaExpr0
syn match   luaBinop1    contained                  /[<>=~^&|*/%+-]/                                                           skipwhite skipempty nextgroup=@luaExpr1
syn match   luaBinop2    contained                  /[<>=~^&|*/%+-]/                                                           skipwhite skipempty nextgroup=@luaExpr2
syn match   luaBinop3    contained                  /[<>=~^&|*/%+-]/                                                           skipwhite skipempty nextgroup=@luaExpr3
syn match   luaBinop4    contained                  /[<>=~^&|*/%+-]/                                                           skipwhite skipempty nextgroup=@luaExpr4
syn match   luaBinop5    contained                  /[<>=~^&|*/%+-]/                                                           skipwhite skipempty nextgroup=@luaExpr5
syn match   luaBinop0    contained                  ://\|>>\|<<\|\.\.\|[<>=~]=:                                                skipwhite skipempty nextgroup=@luaExpr0
syn match   luaBinop1    contained                  ://\|>>\|<<\|\.\.\|[<>=~]=:                                                skipwhite skipempty nextgroup=@luaExpr1
syn match   luaBinop2    contained                  ://\|>>\|<<\|\.\.\|[<>=~]=:                                                skipwhite skipempty nextgroup=@luaExpr2
syn match   luaBinop3    contained                  ://\|>>\|<<\|\.\.\|[<>=~]=:                                                skipwhite skipempty nextgroup=@luaExpr3
syn match   luaBinop4    contained                  ://\|>>\|<<\|\.\.\|[<>=~]=:                                                skipwhite skipempty nextgroup=@luaExpr4
syn match   luaBinop5    contained                  ://\|>>\|<<\|\.\.\|[<>=~]=:                                                skipwhite skipempty nextgroup=@luaExpr5
syn match   luaBinop0    contained                  /\<and\>\|\<or\>/                                                          skipwhite skipempty nextgroup=@luaExpr0
syn match   luaBinop1    contained                  /\<and\>\|\<or\>/                                                          skipwhite skipempty nextgroup=@luaExpr1
syn match   luaBinop2    contained                  /\<and\>\|\<or\>/                                                          skipwhite skipempty nextgroup=@luaExpr2
syn match   luaBinop3    contained                  /\<and\>\|\<or\>/                                                          skipwhite skipempty nextgroup=@luaExpr3
syn match   luaBinop4    contained                  /\<and\>\|\<or\>/                                                          skipwhite skipempty nextgroup=@luaExpr4
syn match   luaBinop5    contained                  /\<and\>\|\<or\>/                                                          skipwhite skipempty nextgroup=@luaExpr5
...
syn region  luaString0                            start=/'/                  end=/'/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix0
syn region  luaString1   contained                          start=/'/                  end=/'/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix1
syn region  luaString2   contained                          start=/'/                  end=/'/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix2
syn region  luaString3   contained                          start=/'/                  end=/'/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix3
syn region  luaString4   contained                          start=/'/                  end=/'/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix4
syn region  luaString5   contained                          start=/'/                  end=/'/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix5
syn region  luaString0                            start=/"/                  end=/"/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix0
syn region  luaString1   contained                          start=/"/                  end=/"/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix1
syn region  luaString2   contained                          start=/"/                  end=/"/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix2
syn region  luaString3   contained                          start=/"/                  end=/"/              contains=luaEscape         skipwhite skipempty nextgroup=@luaSuffix3
...
syn match   luaCommentA0                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr0
syn match   luaCommentA1 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr1
syn match   luaCommentA2 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr2
syn match   luaCommentA3 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr3
syn match   luaCommentA4 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr4
syn match   luaCommentA5 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr5
syn region  luaCommentA0                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr0
syn region  luaCommentA1 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr1
syn region  luaCommentA2 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr2
syn region  luaCommentA3 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr3
syn region  luaCommentA4 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr4
syn region  luaCommentA5 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaExpr5
syn match   luaCommentB0                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt0
syn match   luaCommentB1 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt1
syn match   luaCommentB2 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt2
syn match   luaCommentB3 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt3
syn match   luaCommentB4 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt4
syn match   luaCommentB5 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt5
syn region  luaCommentB0                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt0
syn region  luaCommentB1 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt1
syn region  luaCommentB2 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt2
syn region  luaCommentB3 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt3
syn region  luaCommentB4 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt4
syn region  luaCommentB5 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaStmt5
syn match   luaCommentC0                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix0
syn match   luaCommentC1 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix1
syn match   luaCommentC2 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix2
syn match   luaCommentC3 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix3
syn match   luaCommentC4 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix4
syn match   luaCommentC5 contained                          /--.*$/                                         contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix5
syn region  luaCommentC0                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix0
syn region  luaCommentC1 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix1
syn region  luaCommentC2 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix2
syn region  luaCommentC3 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix3
syn region  luaCommentC4 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix4
syn region  luaCommentC5 contained                          start=/--\[\z(=*\)\[/      end=/\]\z1\]/        contains=luaTodo           skipwhite skipempty nextgroup=@luaSuffix5
...
syn region  luaFuncArgs0 contained matchgroup=luaD0 start=/(/                  end=/)/              contains=luaArg1,luaComma1,luaEllipsis1
syn region  luaFuncArgs1 contained matchgroup=luaD1 start=/(/                  end=/)/              contains=luaArg2,luaComma2,luaEllipsis2
syn region  luaFuncArgs2 contained matchgroup=luaD2 start=/(/                  end=/)/              contains=luaArg3,luaComma3,luaEllipsis3
syn region  luaFuncArgs3 contained matchgroup=luaD3 start=/(/                  end=/)/              contains=luaArg4,luaComma4,luaEllipsis4
syn region  luaFuncArgs4 contained matchgroup=luaD4 start=/(/                  end=/)/              contains=luaArg5,luaComma5,luaEllipsis5
syn region  luaFuncArgs5 contained matchgroup=luaD5 start=/(/                  end=/)/              contains=luaArg0,luaComma0,luaEllipsis0
...
syn region  luaIf0               matchgroup=luaD0 start=/\<if\>/             end=/\ze\<then\>/    contains=@luaExpr1         skipwhite skipempty nextgroup=luaIfBody0
syn region  luaIf1       contained         matchgroup=luaD1 start=/\<if\>/             end=/\ze\<then\>/    contains=@luaExpr2         skipwhite skipempty nextgroup=luaIfBody1
syn region  luaIf2       contained         matchgroup=luaD2 start=/\<if\>/             end=/\ze\<then\>/    contains=@luaExpr3         skipwhite skipempty nextgroup=luaIfBody2
syn region  luaIf3       contained         matchgroup=luaD3 start=/\<if\>/             end=/\ze\<then\>/    contains=@luaExpr4         skipwhite skipempty nextgroup=luaIfBody3
syn region  luaIf4       contained         matchgroup=luaD4 start=/\<if\>/             end=/\ze\<then\>/    contains=@luaExpr5         skipwhite skipempty nextgroup=luaIfBody4
syn region  luaIf5       contained         matchgroup=luaD5 start=/\<if\>/             end=/\ze\<then\>/    contains=@luaExpr0         skipwhite skipempty nextgroup=luaIfBody5
...
syn region  luaElse0     contained matchgroup=luaD0 start=/\<elseif\>/         end=/\<then\>/       contains=@luaExpr1
syn region  luaElse1     contained matchgroup=luaD1 start=/\<elseif\>/         end=/\<then\>/       contains=@luaExpr2
syn region  luaElse2     contained matchgroup=luaD2 start=/\<elseif\>/         end=/\<then\>/       contains=@luaExpr3
syn region  luaElse3     contained matchgroup=luaD3 start=/\<elseif\>/         end=/\<then\>/       contains=@luaExpr4
syn region  luaElse4     contained matchgroup=luaD4 start=/\<elseif\>/         end=/\<then\>/       contains=@luaExpr5
syn region  luaElse5     contained matchgroup=luaD5 start=/\<elseif\>/         end=/\<then\>/       contains=@luaExpr0
...
syn region  luaLoop0             matchgroup=luaD0 start=/\<while\>/          end=/\ze\<do\>/      contains=@luaExpr1         skipwhite skipempty nextgroup=luaDo0
syn region  luaLoop1     contained         matchgroup=luaD1 start=/\<while\>/          end=/\ze\<do\>/      contains=@luaExpr2         skipwhite skipempty nextgroup=luaDo1
syn region  luaLoop2     contained         matchgroup=luaD2 start=/\<while\>/          end=/\ze\<do\>/      contains=@luaExpr3         skipwhite skipempty nextgroup=luaDo2
syn region  luaLoop3     contained         matchgroup=luaD3 start=/\<while\>/          end=/\ze\<do\>/      contains=@luaExpr4         skipwhite skipempty nextgroup=luaDo3
syn region  luaLoop4     contained         matchgroup=luaD4 start=/\<while\>/          end=/\ze\<do\>/      contains=@luaExpr5         skipwhite skipempty nextgroup=luaDo4
syn region  luaLoop5     contained         matchgroup=luaD5 start=/\<while\>/          end=/\ze\<do\>/      contains=@luaExpr0         skipwhite skipempty nextgroup=luaDo5
syn region  luaLoop0             matchgroup=luaD0 start=/\<for\>/            end=/\ze\<do\>/      contains=@luaExpr1,luaIn0  skipwhite skipempty nextgroup=luaDo0
syn region  luaLoop1     contained         matchgroup=luaD1 start=/\<for\>/            end=/\ze\<do\>/      contains=@luaExpr2,luaIn1  skipwhite skipempty nextgroup=luaDo1
syn region  luaLoop2     contained         matchgroup=luaD2 start=/\<for\>/            end=/\ze\<do\>/      contains=@luaExpr3,luaIn2  skipwhite skipempty nextgroup=luaDo2
syn region  luaLoop3     contained         matchgroup=luaD3 start=/\<for\>/            end=/\ze\<do\>/      contains=@luaExpr4,luaIn3  skipwhite skipempty nextgroup=luaDo3
syn region  luaLoop4     contained         matchgroup=luaD4 start=/\<for\>/            end=/\ze\<do\>/      contains=@luaExpr5,luaIn4  skipwhite skipempty nextgroup=luaDo4
syn region  luaLoop5     contained         matchgroup=luaD5 start=/\<for\>/            end=/\ze\<do\>/      contains=@luaExpr0,luaIn5  skipwhite skipempty nextgroup=luaDo5
syn region  luaDo0               matchgroup=luaD0 start=/\<do\>/             end=/\<end\>/        contains=@luaStmt1
syn region  luaDo1       contained         matchgroup=luaD1 start=/\<do\>/             end=/\<end\>/        contains=@luaStmt2
syn region  luaDo2       contained         matchgroup=luaD2 start=/\<do\>/             end=/\<end\>/        contains=@luaStmt3
syn region  luaDo3       contained         matchgroup=luaD3 start=/\<do\>/             end=/\<end\>/        contains=@luaStmt4
syn region  luaDo4       contained         matchgroup=luaD4 start=/\<do\>/             end=/\<end\>/        contains=@luaStmt5
syn region  luaDo5       contained         matchgroup=luaD5 start=/\<do\>/             end=/\<end\>/        contains=@luaStmt0
...
syn region  luaLoop0             matchgroup=luaD0 start=/\<repeat\>/         end=/\<until\>/      contains=@luaStmt1         skipwhite skipempty nextgroup=@luaExpr1
syn region  luaLoop1     contained         matchgroup=luaD1 start=/\<repeat\>/         end=/\<until\>/      contains=@luaStmt2         skipwhite skipempty nextgroup=@luaExpr2
syn region  luaLoop2     contained         matchgroup=luaD2 start=/\<repeat\>/         end=/\<until\>/      contains=@luaStmt3         skipwhite skipempty nextgroup=@luaExpr3
syn region  luaLoop3     contained         matchgroup=luaD3 start=/\<repeat\>/         end=/\<until\>/      contains=@luaStmt4         skipwhite skipempty nextgroup=@luaExpr4
syn region  luaLoop4     contained         matchgroup=luaD4 start=/\<repeat\>/         end=/\<until\>/      contains=@luaStmt5         skipwhite skipempty nextgroup=@luaExpr5
syn region  luaLoop5     contained         matchgroup=luaD5 start=/\<repeat\>/         end=/\<until\>/      contains=@luaStmt0         skipwhite skipempty nextgroup=@luaExpr0
...
hi def link luaComma1      luaD0
hi def link luaComma2      luaD1
hi def link luaComma3      luaD2
hi def link luaComma4      luaD3
hi def link luaComma5      luaD4
hi def link luaComma0      luaD5
...
hi def link luaSemi1       luaD0
hi def link luaSemi2       luaD1
hi def link luaSemi3       luaD2
hi def link luaSemi4       luaD3
hi def link luaSemi5       luaD4
hi def link luaSemi0       luaD5
...
" vim: colorcolumn=13,26,36,53,80,101,128
